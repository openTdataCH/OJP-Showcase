...
Demo URL: https://tools.opentransportdata.swiss/gtfs-rt-status/
...
31.May 2024
- use [GTFS DB Catalog](https://tools.opentransportdata.swiss/gtfs-static-dbs/gtfs-static-dbs.json) to fetch info about the latest imported DB
...
29.May 2022
- use new demo URL - https://tools.opentransportdata.swiss/gtfs-rt-status/
